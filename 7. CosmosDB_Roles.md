...
# SDK limitation
LAB mostly will fail if you use Service Principal to connect and create DB and Container using SDK. In that case please use Master Key, couldn't figure out how to run RBAC and the roles DB Operator for Singapore doesn't even exist.

These actions will need to be executed from Azure Resource Manager Templates, PowerShell, Azure CLI, REST, or Azure Management Library.
