...
1. The minimum MaxIntegratedCacheStaleness value is 0 and the maximum value is 10 years. 
2. When not explicitly configured, the MaxIntegratedCacheStaleness defaults to 5 minutes.
