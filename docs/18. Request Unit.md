...
![Capacity Mode](img/capacity_mode.png)
...
## RU costs
Azure Cosmos DB is billed in units of 100 RU/s per hour. If your rate is 0.8 cents per 100 RU/s per hour (which is the standard rate of \$0.008 USD).
