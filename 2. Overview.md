...
1. SQL (Core) API (exam only focus on this)
2. MongoDB API
3. Cassandra API
4. Gremlin API
5. Table API
...
## Classes
These are useful for ARM/Bicep Configuration or references.
...
<img width="356" height="235" alt="Image" src="https://github.com/user-attachments/assets/149cf124-9284-4ef0-a4ac-807eaa571977" />
...
## How to set the maximum aitosxale
1. Min is always set 0.1% of the max. So 1000 RU is 100 minimum RU.
