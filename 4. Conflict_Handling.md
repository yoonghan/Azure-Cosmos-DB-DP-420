...
3. If you are using "Last Writer Wins," you can actually update the Path (e.g., changing it from /_ts to /myCustomId) on the fly. What you CANNOT change: You cannot toggle the Mode dropdown. It will be grayed out.
