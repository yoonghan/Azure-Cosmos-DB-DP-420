...
![Partition](999.img/partitioning_log_phy.png)
...
![Partitioning Batch](999.img/partitioning_batch.png)
...
$$\text{Unique Constraint} = \text{Partition Key Value} + \text{Unique Key Value}$$
