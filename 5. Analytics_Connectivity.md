...
2. Deprecated, but may still appear in exam. https://learn.microsoft.com/en-us/azure/cosmos-db/configure-synapse-link?context=%2Fazure%2Fcosmos-db%2Fcontext%2Fcontext

![Enable Analytics](999.img/analytics_enable.png)
...
** Null: Setting the TTL value of the operational store of container1 to null will prevent the automatic expiration of items in the container, at which point, the item-level TTL values will take effect. NOTE This is not a valid value, but in some paper/document it notes this can be set...contradicting.
