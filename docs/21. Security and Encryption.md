...
- The DEKs are created at client-side using the Azure Cosmos DB SDK. 
...
- Each DEK you create **can be used to encrypt many properties** or **only one property**. You can **have multiple DEKs per databases**.
