...
1. Enable CORS for a domain to be used to access Azure Cosmos DB from within a browser, the web app URL must be added to the list of allowed domains in the Azure portal. 
