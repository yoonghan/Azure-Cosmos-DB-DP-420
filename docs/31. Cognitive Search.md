# Cognitive Search
1. Also known as a search method that uses machine learning to understand the meaning of a search query and return results that are most relevant to the query. 
2. Highlight is that there is a scheduled "indexer" that runs query. This is "Azure AI Search" example.
3. https://microsoftlearning.github.io/dp-420-cosmos-db-dev/instructions/15-cognitive-search.html

![Cognitive Search](img/cognitivesearch.png)
...
![Delete Policy](img/cognitivesearch_delete.png)
